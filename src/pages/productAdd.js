...
import {
	StyleSheet, CheckBox, View
  } from 'react-native';
import { Container, Content, Button, Text, Item, Label, Input, Form, Toast } from 'native-base';
import $ from 'jquery';
...
class FormProduto extends Component{
	...
	render(){
      ...
      <Item stackedLabel style={style.item}>
        ...
        <Input style={style.input} underline={false} value={this.state.titulo} onChange={this.setTitulo} />
      </Item>
      <Item stackedLabel style={[style.item, style.itemDesc]}>
        <Label style={style.label}>Descricao</Label>
        <Input style={style.input} value={this.state.descricao} onChange={this.setDescricao} />
      </Item>
     ...
     <View style={{flex: 1, flexDirection: 'row', justifyContent: 'center'}}>
      ...
      <Item stackedLabel style={style.item}>
        ...
        <Input style={style.input} value={this.state.pacote} onChange={this.setPacote} />
      </Item>
      <Item stackedLabel style={style.item}> 
        <Label style={style.label}>Valor</Label>
        <Input style={style.input} value={this.state.valor} onChange={this.setValor} />
      </Item>
      <Item stackedLabel style={style.item}>
        <Label style={style.label}>Unitario</Label>
        <Input style={style.input} value={this.state.unitario} onChange={this.setUnitario} />
      </Item>
      <Item stackedLabel style={style.item}>
        <Label style={style.label}>Fornecedor</Label>
        <Input style={style.input} value={this.state.fornecedor} onChange={this.setFornecedor} />
      </Item>
      <Item stackedLabel style={style.item}>
        <Label style={style.label}>Gluten</Label>
        <Input style={style.input} value={this.state.gluten} onChange={this.setGluten} />
      </Item>
      <Item stackedLabel style={style.item}>
        <Label style={style.label}>Porcoes</Label>
        <Input style={style.input} value={this.state.porcoes} onChange={this.setPorcoes} />
      </Item>
      <Item stackedLabel underline='false' style={style.lastItem}>
        <Label style={style.label}>Imagem</Label>
        <Input style={style.input} value={this.state.imagem} onChange={this.setImagem} />
      </Item>
